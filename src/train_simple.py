...
if(args.mode):
    ...
    model_path=os.path.join(model_dir,'model_'+model_name+'{epoch:02d}-{val_acc:.2f}.h5')
...
def train_model(model,X_train,y_train):
    ...
    checkpoint = keras.callbacks.ModelCheckpoint(filepath=model_path, monitor='val_acc', verbose=1,save_weights_only=True)
